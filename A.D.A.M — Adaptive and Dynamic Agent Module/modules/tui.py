        ...
        self.menus = {
            ...
            'training': {
                ...
                'items': [
                    ...
                    ('wiki_batch', '📦 Wikipedia Batch', 'Articles per Wikipedia batch'),
                    ('wiki_min_len', '📏 Wikipedia Min Length', 'Min article length (chars)'),
                    ('wiki_api_batch', '🌐 Wikipedia API Batch', 'Articles per API request'),
                    ('dataset_min_len', '📄 Dataset Min Length', 'Min file length (chars)'),
                    ('back', '← Back', 'Return to settings'),
                ]
            },
            'vocab_opt': {
    ...
    def _load_default_settings(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            'training': {
                ...
                'wikipedia_batch_size': TRAINING_CONFIG.WIKIPEDIA_BATCH_SIZE,
                'wikipedia_min_length': TRAINING_CONFIG.WIKIPEDIA_MIN_ARTICLE_LENGTH,
                'wikipedia_api_batch': TRAINING_CONFIG.WIKIPEDIA_API_BATCH_SIZE,
                'dataset_min_length': TRAINING_CONFIG.DATASET_MIN_FILE_LENGTH,
            },
            'vocab_optimization': {
